  ...
  return h('div', { className: "min-h-screen pb-20 bg-[#0a0a0c]" },
    ...
    h('section', { className: "relative h-[400px] flex items-center justify-center overflow-hidden border-b border-white/5" },
      ...
      h('div', { className: "relative z-10 text-center px-6 max-w-3xl" },
        h('span', { className: "inline-block px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-[10px] font-bold uppercase tracking-[0.2em] mb-4" }, "Unblocked & Curated"),
        ...
        h('p', { className: "text-gray-400 text-lg mb-8 max-w-xl mx-auto" }, "Experience high-quality web gaming without restrictions. Curated, fast, and completely unblocked."),
        h('button', { 
    ...
    h('main', { className: "max-w-7xl mx-auto px-6 mt-12" },
      isLoading ? h('div', { className: "flex flex-col items-center justify-center py-20 space-y-4" },
        ...
        h('p', { className: "text-gray-500 font-medium animate-pulse" }, "Loading Games...")
        ...
        h('div', { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8" },
          ...
          ) : h('div', { className: "col-span-full py-20 text-center text-gray-500" }, "No games found.")
        )
      )
    ),
